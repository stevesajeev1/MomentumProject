...
class ImpulseMomentum(Scene):
    def construct(self):
        ...
        finalRHS = MathTex(r"\Delta p").move_to(momentum[2])
        self.add(time)
...
class Credits(Scene):
    def construct(self):
        ...
        pranavRole = Text("Voiceover/Script of Conservation of Momentum + Inelastic Collision", font_size=20).next_to(pranavText, DOWN * 0.8)
        ...
        self.wait()
        self.play(pranav.animate.shift(UP * 7))
        ...
        self.wait()
        self.play(sharon.animate.shift(DOWN * 7))
        steve.scale(0.6)
        amrit.scale(0.6)
        pranav.scale(0.6)
        sharon.scale(0.6)
